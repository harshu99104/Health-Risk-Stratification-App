...
model = joblib.load("riskmanagement.pkl")
...
if st.button("Predict"):
    input_data = pd.DataFrame([[age, length_of_stay,treatment_cost, AbnormalLabCount]], columns=['Age','Lengthofstay','TreatmentCost', 'Abnormallabcount'])
